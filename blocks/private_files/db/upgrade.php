...
/**
 * This file keeps track of upgrades to the private_files block.
 *
 ...
 *
 * @since Moodle 2.8
 * @package private_files
 * @copyright  2014 Frédéric Massart - FMCorz.net
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

/**
 * Upgrade the private_files block
 * @param int $oldversion
 * @param object $block
 */
function xmldb_block_private_files_upgrade($oldversion, $block) {
    global $DB;
