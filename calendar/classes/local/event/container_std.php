 ...
 * Container standard.
 */
class container_std implements container_interface {
    ...
    public function construct() {
        ...
        $this->eventfactory = new cm_event_factory($this->eventmapper, $this->actionfactory,
            $this->coursecache, $this->modulecache);
