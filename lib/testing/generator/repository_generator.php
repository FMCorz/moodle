...
class testing_repository_generator extends component_generator_base {
     ...
     *
     * @param [type] $record data to use to set up the type
     * @param [type] $options options for the set up of the type
     *
    ...
    public function create_type($record = null, array $options = null) {
        ...
        // Create the type.
        $plugintype = new repository_type($type);
        ...
        $plugintype->update_options($record);
