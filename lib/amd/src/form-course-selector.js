...
define(['core/ajax', 'jquery'], function(ajax, $) {
    ...
    return /** @alias module:core/form-course-selector */ {
        ...
        transport: function(selector, query, success, failure) {
            ...
            if (includefrontpage) {
                frontpageid = el.data('frontpageid') || '';
                frontpagefullname = el.data('frontpagefullname') || '';
                frontpageshortname = el.data('frontpageshortname') || '';
                frontpagedisplayname = el.data('frontpagedisplayname') || '';
                includefrontpage = query === ''
                    || frontpagefullname.toUpperCase().indexOf(query.toUpperCase()) > -1
                    || frontpageshortname.toUpperCase().indexOf(query.toUpperCase()) > -1;
            }
            ...
            promise[0].done(function(data) {
                if (includefrontpage) {
                    data.courses.splice(0, 0, {
                        id: frontpageid,
                        displayname: frontpagedisplayname
                    });
                }
                success(data);
            });
