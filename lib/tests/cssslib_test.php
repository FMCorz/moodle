...
class css_optimiser_testcase extends advanced_testcase {
    ...
    public function test_background() {
        ...
        $this->assertEquals($cssout, $this->get_optimiser()->process($cssin));
        ...
        $this->assertEquals($css, $this->get_optimiser()->process($css));
    }
    ...
    protected function try_invalid_css_handling() {
        ...
        foreach ($cssin as $css) {
            $this->assertEquals($cssout, $this->get_optimiser()->process($css));
        }
