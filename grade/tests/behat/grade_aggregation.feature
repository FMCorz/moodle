...
Feature: We can use calculated grade totals
  ...
  Scenario: Natural aggregation with drop lowest
    ...
    Scenario: Natural aggregation from the setup screen
      ...
      And I set the field "Aggregation of Course 1" to "Natural"
      And I set the field "Aggregation of Sub category 1" to "Natural"
      And I set the field "Aggregation of Sub category 2" to "Natural"
