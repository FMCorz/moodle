...
$string['ghostsdays'] = '{$a->sun},{$a->mon},{$a->tue},{$a->wed},{$a->thu},{$a->fri},{$a->sat}';
$string['ghostsmonths'] = '{$a->jan},{$a->feb},{$a->mar},{$a->apr},{$a->may},{$a->jun},{$a->jul},{$a->aug},{$a->sep},{$a->oct},{$a->nov},{$a->dec}';
