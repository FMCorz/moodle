...
require_once($CFG->libdir . '/boxlibv2.php');
...
class repository_boxnet extends repository {
     ...
     * ensures that the format is understood by
     *
     ...
     * @return string|null
     */
    public function get_file_source_info($ref) {
        global $USER;
        $ref = unserialize(self::convert_to_valid_reference($ref));
        return 'Box ('. fullname($USER) . '): ' . $ref->filename;
    }
