 ...
 * \core_course\format_base::instance($courseorid). Format may store it's specific course-dependent options in
...
abstract class format_base {
     ...
     *
     * Please use {@link \core_course\format_base::instance($courseorid)} to get an instance of the format class
     *
     * @param string $format
     * @param int $courseid
     * @return format_base
    ...
    protected static final function get_class_name($format) {
        global $CFG;
        static $classnames = array('site' => '\core_course\format_site');
     ...
     * \core_course\format_base::instance($course)->get_course()->OPTIONNAME (outside of format class)
     *
